...
* Returned Value   : void 
* Comments         :
*   This function to set X,Y coodrate
*
*END*----------------------------------------------------------------------*/
void LCD_set_XY(unsigned char X, unsigned char Y)
{
	LCD_write_byte(0x40 | X, 0);// row
	LCD_write_byte(0x80 | 6*Y, 0);// colum
	sce1;
} 
...
/*FUNCTION*-------------------------------------------------------------------
* 
* Function Name    : GPIO_ConfigurationNOKIA_5110
* Returned Value   : void 
* Comments         :
...
{  
  	...
  	GPIO_InitStructure.GPIO_Pin = GPIO_Pin_0|GPIO_Pin_1|GPIO_Pin_8|GPIO_Pin_10;  	//设置GPIOB0、GPIOB1、GPIOB12
  	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_10MHz;				  	
  	GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;				  	
