...
__inline void LCD_WriteIndex(uint16_t index)
{
	...
	Set_nRd;
	LCD_Delay(0);
	GPIOB->ODR = index;	 /* GPIO_Write(GPIOB,index); */
	LCD_Delay(0);
	Clr_nWr;
	Set_nWr;
}
...
__inline uint16_t LCD_ReadData(void)
{
	...
	/* PB.00(D0), PB.01(D1), PB.02(D2), PB.03(D3), PB.04(D4), PB.05(D5), PB.06(D6), PB.07(D7), PB.08(D8)
	 PB.09(D9), PB.10(D10), PB.11(D11), PB.12(D12), PB.13(D13), PB.14(D14), PB.15(D15)   */
/* 
